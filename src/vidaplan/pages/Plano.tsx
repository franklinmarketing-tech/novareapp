    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <VPCard className="p-5">
          ...
          <p className="text-xs text-[#1b2a3d]/50 mt-1">Parte do aporte com vantagem tributária e foco em longo prazo (VGBL/PGBL).</p>
        </VPCard>
        <VPCard className="p-5">
          ...
          <p className="text-xs text-[#1b2a3d]/50 mt-1">~10% do patrimônio (ITCMD + inventário). Planejar reduz esse custo.</p>
        </VPCard>
      </div>
