...
import { Compass, Sparkles, Sunrise, Wallet, Landmark, LineChart, type LucideIcon } from "lucide-react";
...
export const VIDAPLAN_NAV: VidaPlanNavItem[] = [
  ...
  { to: "/vidaplan/app/independencia", label: "Independência", icon: Sunrise, short: "Independência" },
