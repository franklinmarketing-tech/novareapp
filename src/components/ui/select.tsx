...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label ref={ref} className={cn("py-1.5 pl-8 pr-2 text-[0.75rem] font-semibold uppercase tracking-wider text-muted-foreground/85", className)} {...props} />
));
